...
output$picksDT <- renderDT({
    ...
    datatable(
        ...
        formatStyle(
            "Name",
            target = "row",
            backgroundColor = styleEqual("", "#013369")
        ) %>%
        formatStyle(
            "Week",
            backgroundColor = styleEqual(1:17, rep("#013369", 17)),
            color = styleEqual(1:17, rep("#FFFFFF", 17)),
            fontWeight = styleEqual(1:17, rep("bold", 17)),
            borderTop = styleEqual(1:17, rep("none", 17)),
            borderBottom = styleEqual(1:17, rep("none", 17))
        )
})
DTOutput("picksDT")
```
